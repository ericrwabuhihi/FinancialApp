    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            if (!string.IsNullOrEmpty(returnUrl) && returnUrl != "/")
            {
                ...
                var idx = returnUrl.IndexOf("code=");
                var temp = returnUrl.Substring(idx + 5);
                Guid code = idx > 0 ? new Guid(temp) : Guid.Empty;
                ...
                if (code != Guid.Empty)
                {
                    ...
                    if (db.Users.Any(u => u.InviteEmail == nvtEmail) || db.Users.Any(u => u.UserName == nvtEmail))
                    {
                    ...
                    {
                        // If not, then have the new user register.  The email will be added as their 
                        // "InviteEmail" in the Users table
        ...
        //public ActionResult Login(string returnUrl)
        //{
        //    // Retrieve email code from returnUrl.


        //    // Find invite by email code.
        //    ViewBag.ReturnUrl = returnUrl;
        //    // Test InviteEmail to determine wheather user needs to see log in Page or register page.
        //    return View();
        //}
